...
export default function DryOvenScreen() {
  ...
  const handleSubmit = () => {
    ...
    Alert.alert("✅ Submitted", "Dry Oven details saved successfully!");
  };

  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <Text style={styles.screenTitle}>Dry Oven</Text>
      <Text style={styles.screenSubtitle}>Measure moisture using oven drying.</Text>
